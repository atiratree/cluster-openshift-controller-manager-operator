...
// bindata/v3.11.0/openshift-controller-manager/route-controller-role.yaml
// bindata/v3.11.0/openshift-controller-manager/route-controller-rolebinding.yaml
...
var _v3110OpenshiftControllerManagerRouteControllerRoleYaml = []byte(`apiVersion: rbac.authorization.k8s.io/v1
kind: Role
metadata:
...
func v3110OpenshiftControllerManagerRouteControllerRoleYamlBytes() ([]byte, error) {
	return _v3110OpenshiftControllerManagerRouteControllerRoleYaml, nil
}

func v3110OpenshiftControllerManagerRouteControllerRoleYaml() (*asset, error) {
	bytes, err := v3110OpenshiftControllerManagerRouteControllerRoleYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "v3.11.0/openshift-controller-manager/route-controller-role.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _v3110OpenshiftControllerManagerRouteControllerRolebindingYaml = []byte(`apiVersion: rbac.authorization.k8s.io/v1
kind: RoleBinding
metadata:
  name: system:openshift:openshift-route-controller-manager
  namespace: openshift-route-controller-manager
...
func v3110OpenshiftControllerManagerRouteControllerRolebindingYamlBytes() ([]byte, error) {
	return _v3110OpenshiftControllerManagerRouteControllerRolebindingYaml, nil
}

func v3110OpenshiftControllerManagerRouteControllerRolebindingYaml() (*asset, error) {
	bytes, err := v3110OpenshiftControllerManagerRouteControllerRolebindingYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "v3.11.0/openshift-controller-manager/route-controller-rolebinding.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"v3.11.0/openshift-controller-manager/route-controller-role.yaml":                           v3110OpenshiftControllerManagerRouteControllerRoleYaml,
	"v3.11.0/openshift-controller-manager/route-controller-rolebinding.yaml":                    v3110OpenshiftControllerManagerRouteControllerRolebindingYaml,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"v3.11.0": {nil, map[string]*bintree{
		...
		"openshift-controller-manager": {nil, map[string]*bintree{
			...
			"route-controller-role.yaml":                           {v3110OpenshiftControllerManagerRouteControllerRoleYaml, map[string]*bintree{}},
			"route-controller-rolebinding.yaml":                    {v3110OpenshiftControllerManagerRouteControllerRolebindingYaml, map[string]*bintree{}},
